...
The verified harnesses are `claude`, `codex`, `opencode`, `pi`, `pi-signed`, `grok`, `kimi`, `hermes`, and `zeus`; never dispatch on an unverified adapter.
