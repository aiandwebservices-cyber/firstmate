...
Pure scout: the report is the only deliverable.
Outputs: a thorough report with findings, evidence, and recommendations.
Constraints: never edit project files or propose commits.
Read-only.
