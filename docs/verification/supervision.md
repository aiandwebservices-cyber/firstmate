...
| Hermes / Zeus | Hermes Agent v0.18.2 (2026-08-06) | None usable | Interactive crew worker verified for launch and tool write; semantic busy stays `unknown hermes-unverified`. See [`hermes-adapter.md`](hermes-adapter.md). |
